...
- (a) (2 puntos) Se pide que complete el código proporcionado en esta hoja de respuestas. Tenga que cuenta que sólo se entregará una hoja. Pase a esta hoja el código justo antes de entregar para evitar equivocaciones.
