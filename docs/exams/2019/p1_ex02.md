...
??? note "Mostrar solución"
    1. Ventajas: Ocupa la memoria imprescindible; Desventajas: Tiempo de inserción $O(n)$ (hay que insertar la palabra en su sitio).
    2. Ventajas: Ocupa la memoria imprescindible; Desventajas: Tiempo de inserción $O(1)$ si la tabla tiene un tamaño suficiente, pero se dispara si el grado de ocupación es alto.
    3. Ventajas: Tiempo de inserción $O(1)$ si las claves se distribuyen uniformemente; Desventajas: Ocupa memoria adicional para las listas de acceso.
    4. Desventajas: Ocupa memoria adicional para los enlaces de los nodos; Tiempo de inserción $O(log n)$.
