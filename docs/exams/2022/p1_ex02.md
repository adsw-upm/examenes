...
Dado un conjunto de n%meros, la distancia entre un elemento del conjunto y el resto del conjunto es la m!nima diferencia entre ese n%mero y otro cualquiera del conjunto. Por ejemplo, la distancia de 10 en el conjunto {3,6,10,16,17} es 4, y la de 16 es 1. El elemento m#s aislado del conjunto es el elemento que tenga la distancia mayor. Si varios n%meros tienen esa misma distancia mayor, el m#s aislado es uno cualquiera de ellos. En el conjunto anterior, el elemento m#s aislado es el 10. Podemos suponer que el conjunto tiene al menos un n%mero. Si solo hay uno, seria el m#s aislado y su distancia es infinito.
...
- (a) (1,5 puntos) Se dispone un conjunto de n%meros ordenado por el valor de los n%meros con un array. No hay ninguna estructura de datos adicional, en relaci"n con el conjunto de n%meros. &Qu$ complejidad tendr# el algoritmo m#s eficiente que calcule el n%mero m#s aislado del conjunto? Justifique la respuesta. No se est# pidiendo una implementaci"n.
...
- (b) (1,5 puntos) Se dispone un conjunto de n%meros ordenado por el valor de los n%meros con un #rbol binario. No hay ninguna estructura de datos adicional, en relaci"n con el conjunto de n%meros. Se supone que los n%meros que incluye el #rbol se han insertado de forma aleatoria y son valores aleatorios. &Qu$ complejidad tendr# el algoritmo m#s eficiente que calcule el n%mero m#s aislado del conjunto? Justifique la respuesta. No se est# pidiendo una implementaci"n.
...
- (c) (2 puntos) Se dispone de un #rbol binario que incluye el conjunto de n%meros ordenado por el valor de cada n%mero que representan los nodos. Implemente el m$todo que devuelve la distancia del n%mero para el nodo en el par#metro. La respuesta debe incluir: 
    - 1. La implementaci"n del algoritmo. La puntuaci"n de la pregunta ser# mayor para soluciones m#s eficientes, y menor para las soluciones m#s ineficientes. En las clases Nodo y BSTAislados se puede incluir cualquier atributo o m$todo auxiliar.
