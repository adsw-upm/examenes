...
??? note "Mostrar solución"
    ...
    - Sin expulsión: La implementación de los métodos `adquirir()` y `liberar()` no permite expulsar a una hebra de un recurso ya adquirido. Por tanto, esta condición se cumple para todas las hebras.
