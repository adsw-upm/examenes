...
??? note "Mostrar solución"
    ...
    ```
- (3 puntos) Programe una versión recursiva del método cuantasVeces. .
*Pista*: puede utilizar un método auxiliar privado (que será el recursivo) para recorrer  el  array  de forma  recursiva,  comparando  en  cada  recursión  un  elemento  del  array.  Por  ejemplo,  podría  programar  y llamar a un método privado como el que sigue: 
```java
