...
- (a) (1,5 puntos) Se pide escribir un algoritmo de ordenación con la siguiente interfaz
...
- (b) (1,5 puntos) Estime la complejidad del  algoritmo  del  punto anterior,  contando  el  número  de  comparaciones entre datos (enteros `long`) que hay que hacer en el caso peor.
