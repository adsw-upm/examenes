...
Sean las dos clases siguientes, con dos implementaciones de un método que intercambia el valor de dos variables. 
...
- (a) (2 puntos) Explique, justificando la respuesta, si estas implementaciones son adecuadas para ser invocadas concurrentemente por un conjunto de hebras (threads).
