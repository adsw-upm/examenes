...
```java
01 public void sort(long[] datos) {
...
- (a) (0.5 puntos) Indique el nombre del algoritmo.

??? note "Mostrar solución"
    Se trata del algoritmo de ordenación por inserción.


- (b) (3 puntos) Indique qué cambios haría en el código, indicando el número de línea, para conseguir que el método devolviera el número de veces que compara dos elementos del array.
...
??? note "Mostrar solución"
    ...
    Con respecto a las modificaciones tenemos que la línea 1 es sustituida por:
    ...
    Las líneas 5–8 son sustituidas por:
    ...
    Y después de la línea 10 se añade:
...
- (c) (1.5 puntos) Programe una prueba en JUnit3 de la modificación realizada en el apartado (b), para el caso `{3, 1, 2}`.
