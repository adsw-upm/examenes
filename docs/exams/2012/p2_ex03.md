...
Modifique la clase `Monitor.java` de la práctica 1 donde se han definido una serie de celdas como zona exclusiva en la que sólo puede haber una pieza dentro (o un marciano, o un jugador). Por ejemplo,

![Figura de zona exclusiva](./p2/img-002.png)
