...
- (a) (1 punto) Modifique la clase `Sensor` para que se pueda integrar en una hebra que comparta información con los sensores cercanos cada 30s. Para ello se puede implementar la interfaz `Runnable`.
