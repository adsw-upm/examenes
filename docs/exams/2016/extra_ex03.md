...
??? note "Mostrar solución"
    ...
    El problema de esta (seudo) solución, sin embargo, es que también cualquier número de lectores pueden estar leyendo al mismo tiempo que un escritor escribe, lo cual es desde luego un comportamiento incorrecto.
