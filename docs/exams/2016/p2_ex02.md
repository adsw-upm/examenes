...
- (a) (5 puntos) Se pide que programe el código necesario para que `DetailActivity` tenga el nuevo botón 'Comentar' y realice la funcionalidad descrita cuando se pincha en dicho botón:
<ol>
<li> Muestre una pantalla `ComentarActivity`; </li>
<li> Si el usuario pulsa 'Guardar' en dicha pantalla, se vuelve a `DetailActivity` y se muestra el comentario escrito en la pantalla, junto con la traza informativa “Nuevo comentario”; </li>
<li> Si el usuario pulsa 'Cancelar' en dicha pantalla, se vuelve a `DetailActivity` y se muestra un `Toast` y una traza informativa con el contenido “El usuario no ha hecho comentarios”. </li>
</ol>
