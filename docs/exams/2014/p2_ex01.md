...
??? note "mostrar solución"
    ...
    - Dentro de `MyDbAdapter`, en `DatabaseHelper`, debemos cambiar el String para crear la tabla, añadiendo una columna:
    ...
    - También dentro de `MyDbAdapter`, modificamos `inserfFoto()`:
