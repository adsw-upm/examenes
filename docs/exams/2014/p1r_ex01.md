...
Se llama montón (*heap*) a un *array* de valores enteros en el que, representado como un árbol binario, todo nodo es mayor o igual que culaquiera de sus dos hijos (si existen):
...
- (a) (5 puntos) Sabiendo que la operación de construir un montón a partir de un array de enteros cualquiera tiene una complejidad del orden de $n ∗ log(n)$, se pide encontrar y justificar la complejidad del algoritmo completo de ordenación descrito a continuación:
